...
export function checkAbapSource(source, opts = {}) {
  ...
  if (o.properties) {
    ...
    for (const nodeRoot of prep.nodes) {
      result.findings.push(...checkNodes(nodeRoot, { data, minUi5: o.minUi5, allow: o.allow }));
    }
...
export function checkXmlSource(xml, opts = {}) {
  ...
  if (o.properties) {
    const data = loadSnapshot(o.snapshot);
    result.findings.push(...checkNodes(parseXml(xml), { data, minUi5: o.minUi5, allow: o.allow }));
  }
  return result;
}
