...
export function loadSnapshot(file = DEFAULT_SNAPSHOT) {
  ...
  // the enum table rides along on the controls object so the (public)
  // checkNodes signature stays a single `data` argument
  return Object.defineProperty(raw.controls, '__enums', {
    value: raw.enums || {},
    enumerable: false,
  });
}
