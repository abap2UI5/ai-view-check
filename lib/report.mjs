...
export const FORMATS = ['stylish', 'json', 'markdown'];
...
export function problemsOf(result) {
  ...
  for (const e of result.renderErrors) {
    problems.push({ line: undefined, column: undefined, severity: 'error', message: String(e).replace(/\s+/g, ' ').slice(0, 220), rule: RENDER_RULE });
  }
