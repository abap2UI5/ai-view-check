...
// ---------------------------------------------------------------------------
export function extractDocs(content, resolveExpr, notes) {
  const docs = [];
...
export function extractDocsWithHelpers(content, resolveExpr, notes) {
...
export function prepareAbap(abapSource) {
  ...
  return { nodes, docs, model, notes, helperTokens, usesBuilder: /z2ui5_cl_ai_xml=>factory/.test(content) };
}
